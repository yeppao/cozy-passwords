[![Travis build status shield](https://img.shields.io/travis/yeppao/cozy-passwords/master.svg)](https://travis-ci.org/yeppao/cozy-passwords)
[![Github Release version shield](https://img.shields.io/github/tag/yeppao/cozy-passwords.svg)](https://github.com/yeppao/cozy-passwords/releases)
[![jest](https://facebook.github.io/jest/img/jest-badge.svg)](https://github.com/facebook/jest)


# Cozy passwords

## What's Cozy passwords?
...
Hacking the Cozy Cozy passwords app requires you to [setup a dev environment][setup].

You can then clone the app repository and install dependencies:

```sh
$ git clone https://github.com/yeppao/cozy-passwords.git
$ cd cozy-passwords
$ yarn install
```
...
If you want to work on Cozy passwords and submit code modifications, feel free to open pull-requests! See the [contributing guide][contribute] for more information about how to properly open pull-requests.
...
The lead maintainer for Cozy passwords is [yeppao](https://github.com/yeppao), send him/her a :beers: to say hello!
...
Cozy passwords is developed by yeppao and distributed under the [AGPL v3 license][agpl-3.0].
