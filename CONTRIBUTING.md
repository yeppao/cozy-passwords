# How to contribute to Cozy passwords?
...
If you discover a security issue, please bring it to our attention right away! Please **DO NOT** file a public issue, instead send your report privately to  AT cozycloud DOT cc.
...
- What is the version of the Cozy Cozy passwords?
...
```
$ git clone github.com/yeppao/cozy-passwords.git
$ cd cozy-passwords
...
The Cozy passwords is translated on a platform called [Transifex][tx]. [This tutorial][tx-start] can help you to learn how to make your first steps here. If you have any question, don't hesitate to ask us!
...
[issues]: https://github.com/yeppao/cozy-passwords/issues/new
...
[localization]: https://github.com/yeppao/cozy-passwords/blob/master/README.md#localization
